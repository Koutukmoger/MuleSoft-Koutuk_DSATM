...
<body>
    <div>
        <div class="div1">
           <strong><p>INTERESTED MOVIES</p></strong>
        </div>

        <div class = "div2">
            <strong><p><u>List  of  Movies</u></p></strong>
        </div>
        ...
        <div class="div2">
            <h1 style="padding-bottom:30px;"><strong>Add Movie Interest</strong></h1>
            <form action="index.php" name="form" method="post">
                ...
                <div class="form-group">
                    <input   style="background-color: black; color:white;"type="submit" name="sub"  class="btn btn-light">
                </div>
            </form>   
